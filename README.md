...
| **Specula** — visionOS video player | 🟢 Active (3D Blu-ray (MVC) playback proven on device through the native player; streaming integration next; TMDB metadata chain queued, 2026-09-17) | 🔒 private — doc lives in the project repo |
